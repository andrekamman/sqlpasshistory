...
---|---|---|---|---
18-11-2015 15:00|Vitor Faria Tomaz|24 Hours of PASS (60 minutes)|Application & Database Development|[SQL Azure Database](#sessionid-41127)
18-11-2015 16:00|Andre Batista|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Query Store no SQL Server 2016](#sessionid-41124)
18-11-2015 17:00|Luiz Mercante|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Entendendo o Transaction Log](#sessionid-40976)
18-11-2015 18:00|Marcos Freccia|24 Hours of PASS (60 minutes)|Cloud Application Development & Deployment|[Alta disponibilidade com Azure SQL Database](#sessionid-41089)
18-11-2015 19:00|Niko Neugebauer|24 Hours of PASS (60 minutes)|BI Platform Architecture, Development & Administration|[Understanding & Solving Columnstore Problems](#sessionid-40848)
18-11-2015 20:00|EDVALDO CASTRO|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[HandsOn - SQL Server AlwaysOn Availability Groups](#sessionid-40990)
18-11-2015 21:00|Marcus Vinícius Bittencourt|24 Hours of PASS (60 minutes)|Application & Database Development|[SQL Bad Practice](#sessionid-41385)
18-11-2015 22:00|André Melancia|24 Hours of PASS (60 minutes)|Application & Database Development|[Segredos da ABIN e do SIS - Apps Seguras Com Acesso Multi-Camada](#sessionid-41042)
18-11-2015 23:00|Tiago Balabuch|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Ciclo de vida de uma query](#sessionid-41387)
19-11-2015 00:00|Thiago Zavaschi|24 Hours of PASS (60 minutes)|BI Information Delivery|[Datazen - Arquitetura e Desenvolvimento](#sessionid-41063)
19-11-2015 01:00|Pedro Lopes|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Query optimization and analysis in SQL Server 2016](#sessionid-41247)
19-11-2015 02:00|Rodrigo Crespi|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[10 Dicas para Escrever Codigos T-SQL Melhores](#sessionid-41010)
19-11-2015 15:00|Ivan Campos|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Ocultando dados com SQL Server 2016](#sessionid-41040)
19-11-2015 16:00|Dennes Torres|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Extended Events: Receitas de sucesso para troubleshooting](#sessionid-40957)
19-11-2015 17:00|Marcondes Alexandre|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Boas Práticas de Desempenho e Disaster Recovery no SQL Database](#sessionid-41021)
19-11-2015 18:00|Armando Lacerda|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Alta disponibilidade sem cluster](#sessionid-41139)
19-11-2015 19:00|Cláudio Silva|24 Hours of PASS (60 minutes)|Application & Database Development|[Powershell - Passar de scripts simples a funções avançadas](#sessionid-41081)
19-11-2015 20:00|Etienne Lopes|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Resource Governor for SQL Server 2014 in Action!](#sessionid-41052)
19-11-2015 21:00|Vitor Pombeiro, Pedro Simoes|24 Hours of PASS (60 minutes)|Cloud Application Development & Deployment|[Azure VM's with SQL Server -  Notes from the field](#sessionid-41113)
19-11-2015 22:00|Fabiano Amorim|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Advanced SQL Server Execution Plans](#sessionid-41244)
19-11-2015 23:00|Luan Moreno Medeiros Maciel|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[Hekaton v.2 e ColumnStore Index v.3 - Nova Geração de DBAs](#sessionid-41090)
20-11-2015 00:00|Reinaldo Kibel|24 Hours of PASS (60 minutes)|Enterprise Database Administration & Deployment|[AlwaysOn e realmente poderoso? truques de uso](#sessionid-41487)
20-11-2015 01:00|Dan de Sousa|24 Hours of PASS (60 minutes)|BI Platform Architecture, Development & Administration|[Validacao de Dados Automatizada na Datawarehouse](#sessionid-41015)
20-11-2015 02:00|Marcelo Adade|24 Hours of PASS (60 minutes)|Application & Database Development|[Filegroups - ótimas práticas](#sessionid-41117)
# 
#### SessionID: 41127
# SQL Azure Database
#### [Back to calendar](#id-539)
Event Date: 18-11-2015 15:00 - Category: 24 Hours of PASS (60 minutes) - Track: Application & Database Development
...
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 00:00 - Category: 24 Hours of PASS (60 minutes) - Track: BI Information Delivery
## Speaker(s): Thiago Zavaschi
## Title: Datazen - Arquitetura e Desenvolvimento
## Description:
### Nesta sessão veremos como o Datazen funciona, arquitetura, topologias, bem como a criação e manuteção de dashboards e KPIs. Se você planeja entregar dados através de uma plataforma móvel, esta é a sua sessão.
# 
#### SessionID: 41247
# Query optimization and analysis in SQL Server 2016
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 01:00 - Category: 24 Hours of PASS (60 minutes) - Track: Enterprise Database Administration & Deployment
## Speaker(s): Pedro Lopes
## Title: Query optimization and analysis in SQL Server 2016
## Description:
### System.Xml.XmlElement
# 
#### SessionID: 41010
...
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 02:00 - Category: 24 Hours of PASS (60 minutes) - Track: Enterprise Database Administration & Deployment
## Speaker(s): Rodrigo Crespi
## Title: 10 Dicas para Escrever Codigos T-SQL Melhores
## Description:
### Escrever códigos transact SQL pode ser uma tarefa complicada e algumas vezes caímos em pequenas armadilhas que deterioram a performance ou complicam o debug de problemas. Esta sessão apresentará 10 dicas de como melhorar o código T-SQL para que ele se comporte com melhor performance.
# 
#### SessionID: 41040
# Ocultando dados com SQL Server 2016
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 15:00 - Category: 24 Hours of PASS (60 minutes) - Track: Enterprise Database Administration & Deployment
## Speaker(s): Ivan Campos
## Title: Ocultando dados com SQL Server 2016
## Description:
### Nos últimos tempos a Microsoft tem vindo a anunciar uma serie de novas funcionalidades que estão presentes no enorme produto que é o SQL Server 2016. 

Nesta sessão pretendo apenas cobrir o tópico de segurança, falando desde Row Level security, Dynamic Data Masking e Always encrypted, e cobrirei a versão Azure do produto assim como on-permisses.
# 
#### SessionID: 40957
# Extended Events: Receitas de sucesso para troubleshooting
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 16:00 - Category: 24 Hours of PASS (60 minutes) - Track: Enterprise Database Administration & Deployment
## Speaker(s): Dennes Torres
## Title: Extended Events: Receitas de sucesso para troubleshooting
## Description:
### Desde que o Profiler foi marcado como deprecated Extended Events tem se tornado cada vez mais padrão como ferramenta para captura de eventos no SQL Server. 

Veja algumas receitas muito legais para troubleshooting, tal como captura de deadlocks, blocked process, page splits e mais, além de queries para resgatar essas informações facilmente da sessão XE.
# 
#### SessionID: 41021
# Boas Práticas de Desempenho e Disaster Recovery no SQL Database
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 17:00 - Category: 24 Hours of PASS (60 minutes) - Track: Enterprise Database Administration & Deployment
## Speaker(s): Marcondes Alexandre
## Title: Boas Práticas de Desempenho e Disaster Recovery no SQL Database
## Description:
...
Entre outros veremos como:
 - Criar/importar módulos a partir das funções 
- Tirar partido de: -&gt; Input por pipeline -&gt; Parâmetros comuns aos cmdlets como "-Verbose", "-ErrorAction" e "-WarningAction"
, -&gt; Parâmetros de mitigação de risco como "-WhatIf" e "-Confirm" -&gt; Ajuda 

Iremos ainda ver em ação um conjunto de funções que foram desenvolvidas para automatizar e poupar tempo em casos reais do dia a dia de um DBA.
# 
#### SessionID: 41052
# Resource Governor for SQL Server 2014 in Action!
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 20:00 - Category: 24 Hours of PASS (60 minutes) - Track: Enterprise Database Administration & Deployment
## Speaker(s): Etienne Lopes
## Title: Resource Governor for SQL Server 2014 in Action!
## Description:
### Com o Resource Governor é possível impor limites ao nível do consumo de recursos de CPU, memória e até I/O (novidade no SQL Server 2014) que as aplicações podem usar numa mesma instância. 
Nesta sessão irei apresentar o Resource Governor e farei uma série de demonstrações para mostrar como se pode utilizar e tirar partido desta excelente funcionalidade!
# 
#### SessionID: 41113
# Azure VM's with SQL Server -  Notes from the field
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 21:00 - Category: 24 Hours of PASS (60 minutes) - Track: Cloud Application Development & Deployment
## Speaker(s): Vitor Pombeiro, Pedro Simoes
## Title: Azure VM's with SQL Server -  Notes from the field
## Description:
### Vamos apresentar algumas das boas praticas e a nossa experiencia com máquinas virtuais Azure com SQL Server
# 
#### SessionID: 41244
# Advanced SQL Server Execution Plans
#### [Back to calendar](#id-539)
Event Date: 19-11-2015 22:00 - Category: 24 Hours of PASS (60 minutes) - Track: Enterprise Database Administration & Deployment
